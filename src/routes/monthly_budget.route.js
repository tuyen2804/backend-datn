...
router.get("/:categoryId/:month/:year", verifyToken, monthlyBudgetController.getBudget);

// Cập nhật ngân sách
router.put("/:categoryId/:month/:year", verifyToken, monthlyBudgetController.updateBudget);

// Xóa ngân sách
router.delete("/:categoryId/:month/:year", verifyToken, monthlyBudgetController.deleteBudget);
...
router.get("/summary/:categoryId/:month/:year", verifyToken, monthlyBudgetController.getBudgetVsSpending);
